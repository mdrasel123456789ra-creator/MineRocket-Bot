    ...
    # SETTINGS STEP HANDLERS
        ...
        try:
            if step == "set_channel":
                ...
                save_db(db)
                bot.send_message(chat_id, f"✅ *Minimum withdrawal updated:* *{val} USDT*", parse_mode="Markdown")
...
def callback_handler(call):
    ...
    if data == "check_join":
        ...
        prompts = {
            ...
            "set_min_withdraw":      "💸 Send the minimum withdrawal amount (USDT):\n_Example: 5_",
            "set_mining_reward":     "⛏ Send the mining reward amount (USDT):\n_Example: 0.10_",
